...
const feedbacks = [
  ...
  createData(2,'Arroz com feijão',5, 'Jason Thunder', 'Já sei o que pedi no próximo final de semana, estão de parabéns!'),
  createData(3,'Yakisoba',4, 'Luíza Sonza', 'Só atrasou um pouco, mas está maravilhoso'),
  createData(4,'Feijoada',4, 'Alexis Santorini', 'Assim nem quero cozinhar mais!'),
  createData(5,'Frango Rush',5, 'Antoni Highlander', 'Hmmmm, vou pedir de novo!'),
          ...
          <div key={feedback.id} className={classes.contentWrapper} >
           <Paper className={classes.paper2} elevation={1}>
              <Box component="fieldset" mb={2} borderColor="transparent">
                <Grid  container>
                  <Grid item xs>
                    <Typography  variant="h5"component="legend">{feedback.order}</Typography>
                    <Typography variant="subtitle1">Avaliação:</Typography>
                    <Rating name="read-only" value={feedback.avaliation} readOnly />
            ...
            >
              <DialogTitle id="alert-dialog-title">  Deseja realmente apagar esse Feedback?</DialogTitle>
              <DialogActions>
