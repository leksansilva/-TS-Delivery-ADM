...
export const setExpirationRefreshToken = (expirationRefreshToken) =>
  localStorage.setItem(EXPIRATION_REFRESH_TOKEN, expirationRefreshToken);
export const expirationRefreshToken = () =>
  localStorage.getItem(EXPIRATION_REFRESH_TOKEN);
